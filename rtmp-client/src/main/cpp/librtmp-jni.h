...
Java_net_butterflytv_rtmp_1client_RtmpClient_nativeIsConnected(JNIEnv* env, jobject thiz, jlong);
...
JNIEXPORT void JNICALL
Java_net_butterflytv_rtmp_1client_RTMPMuxer_file_1open(JNIEnv* env, jobject thiz,
                                                       jstring filename_) {
